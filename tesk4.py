...
list_ = [] # Пустой список
chars_list = ["a", "b", "c"]
print("Содержимое переменной list_:", list_, type(list))
print("Содержимое переменной chars_list:",
chars_list,
type(chars_list))
empty_string = "" # Пустая строка
str_ = "test" # Строковый тип данных
print("Содержимое переменной empty_string:",
empty_string,
type(empty_string))
print("Содержимое переменной str_:",str_,
type(str_))
empty_set = set () # Пустое множество
set_ = {3,2, 1, 1} # Множество содержит в себе только уникальные элементы
print("Содержимое переменной empty_set:",
empty_set,
type(empty_set))
